...
abstract Centigram(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Centigram) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Centigram) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Centigram) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Centigram) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Centigram) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Centigram) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Centigram) : Bool

...
abstract Ounce(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Ounce) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Ounce) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Ounce) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Ounce) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Ounce) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Ounce) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Ounce) : Bool

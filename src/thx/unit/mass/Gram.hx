...
abstract Gram(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Gram) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Gram) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Gram) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Gram) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Gram) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Gram) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Gram) : Bool

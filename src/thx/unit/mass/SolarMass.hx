...
abstract SolarMass(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : SolarMass) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : SolarMass) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : SolarMass) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : SolarMass) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : SolarMass) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : SolarMass) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : SolarMass) : Bool

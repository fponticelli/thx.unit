...
abstract Kilogram(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Kilogram) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Kilogram) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Kilogram) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Kilogram) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Kilogram) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Kilogram) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Kilogram) : Bool

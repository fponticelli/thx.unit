...
abstract UnifiedAtomicMassUnit(Decimal) {
  ...
  inline public function equalsTo(that : UnifiedAtomicMassUnit) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : UnifiedAtomicMassUnit, that : UnifiedAtomicMassUnit) : Bool
    return self.toDecimal() == that.toDecimal();

  public function nearEqualsTo(that : UnifiedAtomicMassUnit) : Bool 
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  
  public static function nearEquals(self : UnifiedAtomicMassUnit, that : UnifiedAtomicMassUnit) : Bool 
    return Floats.nearEquals(self.toFloat(), that.toFloat());
  

  inline public function notEqualsTo(that : UnifiedAtomicMassUnit) : Bool
    return this != that.toDecimal();
  @:op(A!=B)
  inline static public function notEquals(self : UnifiedAtomicMassUnit, that : UnifiedAtomicMassUnit) : Bool
    return self.toDecimal() != that.toDecimal();

  inline public function lessThan(that : UnifiedAtomicMassUnit) : Bool
    return this < that.toDecimal();
  @:op( A<B)
  inline static public function less(self : UnifiedAtomicMassUnit, that : UnifiedAtomicMassUnit) : Bool
    return self.toDecimal() < that.toDecimal();

  inline public function lessEqualsTo(that : UnifiedAtomicMassUnit) : Bool
    return this <= that.toDecimal();
  @:op(A<=B)
  inline static public function lessEquals(self : UnifiedAtomicMassUnit, that : UnifiedAtomicMassUnit) : Bool
    return self.toDecimal() <= that.toDecimal();

  inline public function greaterThan(that : UnifiedAtomicMassUnit) : Bool
    return this > that.toDecimal();
  @:op( A>B)
  inline static public function greater(self : UnifiedAtomicMassUnit, that : UnifiedAtomicMassUnit) : Bool
    return self.toDecimal() >= that.toDecimal();

  inline public function greaterEqualsTo(that : UnifiedAtomicMassUnit) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : UnifiedAtomicMassUnit, that : UnifiedAtomicMassUnit) : Bool
    return self.toDecimal() >= that.toDecimal();

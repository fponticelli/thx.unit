...
abstract UnifiedAtomicMassUnit(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : UnifiedAtomicMassUnit) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : UnifiedAtomicMassUnit) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : UnifiedAtomicMassUnit) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : UnifiedAtomicMassUnit) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : UnifiedAtomicMassUnit) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : UnifiedAtomicMassUnit) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : UnifiedAtomicMassUnit) : Bool

...
abstract Drachm(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Drachm) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Drachm) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Drachm) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Drachm) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Drachm) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Drachm) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Drachm) : Bool

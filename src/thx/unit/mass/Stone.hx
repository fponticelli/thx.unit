...
abstract Stone(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Stone) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Stone) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Stone) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Stone) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Stone) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Stone) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Stone) : Bool

...
abstract PlankMass(Decimal) {
  static var ofUnit : Decimal = "2.17651e-8"; 
  ...
  inline public function equalsTo(that : PlankMass) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : PlankMass, that : PlankMass) : Bool
  ...
  inline public function greaterEqualsTo(that : PlankMass) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : PlankMass, that : PlankMass) : Bool
    return self.toDecimal() >= that.toDecimal();

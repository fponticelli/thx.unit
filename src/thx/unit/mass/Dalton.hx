...
abstract Dalton(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Dalton) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Dalton) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Dalton) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Dalton) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Dalton) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Dalton) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Dalton) : Bool

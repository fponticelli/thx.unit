...
abstract League(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : League) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : League) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : League) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : League) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : League) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : League) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : League) : Bool

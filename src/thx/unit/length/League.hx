...
abstract League(Decimal) {
  ...
  public static function nearEquals(self : League, that : League) : Bool 
    return Floats.nearEquals(self.toFloat(), that.toFloat());
  

  inline public function notEqualsTo(that : League) : Bool
    return this != that.toDecimal();
  @:op(A!=B)
  inline static public function notEquals(self : League, that : League) : Bool
    return self.toDecimal() != that.toDecimal();

  inline public function lessThan(that : League) : Bool
    return this < that.toDecimal();
  @:op( A<B)
  inline static public function less(self : League, that : League) : Bool
    return self.toDecimal() < that.toDecimal();

  inline public function lessEqualsTo(that : League) : Bool
    return this <= that.toDecimal();
  @:op(A<=B)
  inline static public function lessEquals(self : League, that : League) : Bool
    return self.toDecimal() <= that.toDecimal();

  inline public function greaterThan(that : League) : Bool
    return this > that.toDecimal();
  @:op( A>B)
  inline static public function greater(self : League, that : League) : Bool
    return self.toDecimal() >= that.toDecimal();

  inline public function greaterEqualsTo(that : League) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : League, that : League) : Bool
    return self.toDecimal() >= that.toDecimal();

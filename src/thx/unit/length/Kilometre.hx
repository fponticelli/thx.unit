...
abstract Kilometre(Decimal) {
  ...
  public static function nearEquals(self : Kilometre, that : Kilometre) : Bool 
    return Floats.nearEquals(self.toFloat(), that.toFloat());
  

  inline public function notEqualsTo(that : Kilometre) : Bool
    return this != that.toDecimal();
  @:op(A!=B)
  inline static public function notEquals(self : Kilometre, that : Kilometre) : Bool
    return self.toDecimal() != that.toDecimal();

  inline public function lessThan(that : Kilometre) : Bool
    return this < that.toDecimal();
  @:op( A<B)
  inline static public function less(self : Kilometre, that : Kilometre) : Bool
    return self.toDecimal() < that.toDecimal();

  inline public function lessEqualsTo(that : Kilometre) : Bool
    return this <= that.toDecimal();
  @:op(A<=B)
  inline static public function lessEquals(self : Kilometre, that : Kilometre) : Bool
    return self.toDecimal() <= that.toDecimal();

  inline public function greaterThan(that : Kilometre) : Bool
    return this > that.toDecimal();
  @:op( A>B)
  inline static public function greater(self : Kilometre, that : Kilometre) : Bool
    return self.toDecimal() >= that.toDecimal();

  inline public function greaterEqualsTo(that : Kilometre) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : Kilometre, that : Kilometre) : Bool
    return self.toDecimal() >= that.toDecimal();

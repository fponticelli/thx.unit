...
abstract Kilometre(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Kilometre) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Kilometre) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Kilometre) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Kilometre) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Kilometre) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Kilometre) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Kilometre) : Bool

...
abstract Line(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Line) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Line) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Line) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Line) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Line) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Line) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Line) : Bool

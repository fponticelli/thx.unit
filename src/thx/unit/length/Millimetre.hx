...
abstract Millimetre(Decimal) {
  ...
  inline public function equalsTo(that : Millimetre) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : Millimetre, that : Millimetre) : Bool
  ...
  inline public function greaterEqualsTo(that : Millimetre) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : Millimetre, that : Millimetre) : Bool
    return self.toDecimal() >= that.toDecimal();

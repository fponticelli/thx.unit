...
abstract Hour(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Hour) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Hour) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Hour) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Hour) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Hour) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Hour) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Hour) : Bool

...
abstract Minute(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Minute) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Minute) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Minute) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Minute) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Minute) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Minute) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Minute) : Bool

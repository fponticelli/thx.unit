...
abstract Minute(Decimal) {
  ...
  inline public function equalsTo(that : Minute) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : Minute, that : Minute) : Bool
    return self.toDecimal() == that.toDecimal();

  public function nearEqualsTo(that : Minute) : Bool 
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  
  public static function nearEquals(self : Minute, that : Minute) : Bool 
    return Floats.nearEquals(self.toFloat(), that.toFloat());
  

  inline public function notEqualsTo(that : Minute) : Bool
    return this != that.toDecimal();
  @:op(A!=B)
  inline static public function notEquals(self : Minute, that : Minute) : Bool
    return self.toDecimal() != that.toDecimal();

  inline public function lessThan(that : Minute) : Bool
    return this < that.toDecimal();
  @:op( A<B)
  inline static public function less(self : Minute, that : Minute) : Bool
    return self.toDecimal() < that.toDecimal();

  inline public function lessEqualsTo(that : Minute) : Bool
    return this <= that.toDecimal();
  @:op(A<=B)
  inline static public function lessEquals(self : Minute, that : Minute) : Bool
    return self.toDecimal() <= that.toDecimal();

  inline public function greaterThan(that : Minute) : Bool
    return this > that.toDecimal();
  @:op( A>B)
  inline static public function greater(self : Minute, that : Minute) : Bool
    return self.toDecimal() >= that.toDecimal();

  inline public function greaterEqualsTo(that : Minute) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : Minute, that : Minute) : Bool
    return self.toDecimal() >= that.toDecimal();

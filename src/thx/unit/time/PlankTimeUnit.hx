...
abstract PlankTimeUnit(Decimal) {
  static var ofUnit : Decimal = "5.39e-44"; 
  ...
  inline public function equalsTo(that : PlankTimeUnit) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : PlankTimeUnit, that : PlankTimeUnit) : Bool
  ...
  inline public function greaterEqualsTo(that : PlankTimeUnit) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : PlankTimeUnit, that : PlankTimeUnit) : Bool
    return self.toDecimal() >= that.toDecimal();
 inline public function toDecimal() : Decimal
  ...
  @:from static public function fromTime(time : thx.Time) : PlankTimeUnit
    return Tick.fromDecimal(thx.Decimal.fromInt64(time.ticks)).toPlankTimeUnit();

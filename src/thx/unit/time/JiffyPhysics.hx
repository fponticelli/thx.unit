...
abstract JiffyPhysics(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : JiffyPhysics) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : JiffyPhysics) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : JiffyPhysics) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : JiffyPhysics) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : JiffyPhysics) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : JiffyPhysics) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : JiffyPhysics) : Bool

...
abstract Day(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : Day) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : Day) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Day) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : Day) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : Day) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : Day) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : Day) : Bool

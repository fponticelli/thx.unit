...
abstract Day(Decimal) {
  static var ofUnit : Decimal = "86400"; 
  ...
  inline public function equalsTo(that : Day) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : Day, that : Day) : Bool
    return self.toDecimal() == that.toDecimal();

  public function nearEqualsTo(that : Day) : Bool 
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  
  public static function nearEquals(self : Day, that : Day) : Bool 
    return Floats.nearEquals(self.toFloat(), that.toFloat());
  

  inline public function notEqualsTo(that : Day) : Bool
    return this != that.toDecimal();
  @:op(A!=B)
  inline static public function notEquals(self : Day, that : Day) : Bool
    return self.toDecimal() != that.toDecimal();

  inline public function lessThan(that : Day) : Bool
    return this < that.toDecimal();
  @:op( A<B)
  inline static public function less(self : Day, that : Day) : Bool
    return self.toDecimal() < that.toDecimal();

  inline public function lessEqualsTo(that : Day) : Bool
    return this <= that.toDecimal();
  @:op(A<=B)
  inline static public function lessEquals(self : Day, that : Day) : Bool
    return self.toDecimal() <= that.toDecimal();

  inline public function greaterThan(that : Day) : Bool
    return this > that.toDecimal();
  @:op( A>B)
  inline static public function greater(self : Day, that : Day) : Bool
    return self.toDecimal() >= that.toDecimal();

  inline public function greaterEqualsTo(that : Day) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : Day, that : Day) : Bool
    return self.toDecimal() >= that.toDecimal();

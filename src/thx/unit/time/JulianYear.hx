...
abstract JulianYear(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : JulianYear) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : JulianYear) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : JulianYear) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : JulianYear) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : JulianYear) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : JulianYear) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : JulianYear) : Bool

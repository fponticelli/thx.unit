...
abstract Svedberg(Decimal) {
  static var ofUnit : Decimal = "1e-13"; 
  ...
  inline public function equalsTo(that : Svedberg) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : Svedberg, that : Svedberg) : Bool
  ...
  inline public function greaterEqualsTo(that : Svedberg) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : Svedberg, that : Svedberg) : Bool
    return self.toDecimal() >= that.toDecimal();
 inline public function toDecimal() : Decimal
  ...
  @:from static public function fromTime(time : thx.Time) : Svedberg
    return Tick.fromDecimal(thx.Decimal.fromInt64(time.ticks)).toSvedberg();

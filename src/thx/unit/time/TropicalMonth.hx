...
abstract TropicalMonth(Decimal) {
  ...
  @:op(A==B) inline public function equals(that : TropicalMonth) : Bool
    return this.equalsTo(that.toDecimal());
  public function nearEquals(that : TropicalMonth) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : TropicalMonth) : Bool
    return !this.equalsTo(that.toDecimal());
  @:op( A<B) inline public function less(that : TropicalMonth) : Bool
    return this.lessThan(that.toDecimal());
  @:op(A<=B) inline public function lessEquals(that : TropicalMonth) : Bool
    return this.lessEqualsTo(that.toDecimal());
  @:op( A>B) inline public function greater(that : TropicalMonth) : Bool
    return this.greaterThan(that.toDecimal());
  @:op(A>=B) inline public function greaterEquals(that : TropicalMonth) : Bool

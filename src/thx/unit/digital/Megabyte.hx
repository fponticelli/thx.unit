...
abstract Megabyte(BigInt) {
  static var ofUnit : BigInt = "1048576";

  @:from inline static public function fromBigInt(value : BigInt) : Megabyte
  ...
  @:op( A*B) inline public function multiply(that : BigInt) : Megabyte
    return this.multiply(that);
  @:op( A/B) inline public function divide(that : BigInt) : Megabyte
    return this.divide(that);
  @:op( A%B) inline public function modulo(that : BigInt) : Megabyte
    return this.modulo(that);
  @:op(A==B) inline public function equals(that : Megabyte) : Bool
    return this.equalsTo(that.toBigInt());
  public function nearEquals(that : Megabyte) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Megabyte) : Bool
    return !this.equalsTo(that.toBigInt());
  @:op( A<B) inline public function less(that : Megabyte) : Bool
    return this.lessThan(that.toBigInt());
  @:op(A<=B) inline public function lessEquals(that : Megabyte) : Bool
  ...
  @:op(A>=B) inline public function greaterEquals(that : Megabyte) : Bool

...
abstract Zettabit(BigInt) {
  static var ofUnit : BigInt = "1E21";

  @:from inline static public function fromBigInt(value : BigInt) : Zettabit
  ...
  @:op( A*B) inline public function multiply(that : BigInt) : Zettabit
    return this.multiply(that);
  @:op( A/B) inline public function divide(that : BigInt) : Zettabit

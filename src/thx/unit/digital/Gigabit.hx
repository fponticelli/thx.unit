...
abstract Gigabit(BigInt) {
  static var ofUnit : BigInt = "1000000000";

  @:from inline static public function fromBigInt(value : BigInt) : Gigabit
  ...
  @:op( A*B) inline public function multiply(that : BigInt) : Gigabit
    return this.multiply(that);
  @:op( A/B) inline public function divide(that : BigInt) : Gigabit

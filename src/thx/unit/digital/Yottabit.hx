...
abstract Yottabit(Decimal) {
  static var ofUnit : Decimal = "1E24"; 
  ...
  inline public function equalsTo(that : Yottabit) : Bool
    return this == that.toDecimal();
  @:op(A==B)
  inline static public function equals(self : Yottabit, that : Yottabit) : Bool
    return self.toDecimal() == that.toDecimal();

  public function nearEqualsTo(that : Yottabit) : Bool 
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  
  public static function nearEquals(self : Yottabit, that : Yottabit) : Bool 
    return Floats.nearEquals(self.toFloat(), that.toFloat());
  

  inline public function notEqualsTo(that : Yottabit) : Bool
    return this != that.toDecimal();
  @:op(A!=B)
  inline static public function notEquals(self : Yottabit, that : Yottabit) : Bool
    return self.toDecimal() != that.toDecimal();

  inline public function lessThan(that : Yottabit) : Bool
    return this < that.toDecimal();
  @:op( A<B)
  inline static public function less(self : Yottabit, that : Yottabit) : Bool
    return self.toDecimal() < that.toDecimal();

  inline public function lessEqualsTo(that : Yottabit) : Bool
    return this <= that.toDecimal();
  @:op(A<=B)
  inline static public function lessEquals(self : Yottabit, that : Yottabit) : Bool
    return self.toDecimal() <= that.toDecimal();

  inline public function greaterThan(that : Yottabit) : Bool
    return this > that.toDecimal();
  @:op( A>B)
  inline static public function greater(self : Yottabit, that : Yottabit) : Bool
    return self.toDecimal() >= that.toDecimal();

  inline public function greaterEqualsTo(that : Yottabit) : Bool
    return this >= that.toDecimal();
  @:op(A>=B)
  inline static public function greaterEquals(self : Yottabit, that : Yottabit) : Bool
    return self.toDecimal() >= that.toDecimal();

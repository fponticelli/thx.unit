...
abstract Yottabit(BigInt) {
  static var ofUnit : BigInt = "1E24";

  @:from inline static public function fromBigInt(value : BigInt) : Yottabit
  ...
  @:op( A*B) inline public function multiply(that : BigInt) : Yottabit
    return this.multiply(that);
  @:op( A/B) inline public function divide(that : BigInt) : Yottabit
    return this.divide(that);
  @:op( A%B) inline public function modulo(that : BigInt) : Yottabit
    return this.modulo(that);
  @:op(A==B) inline public function equals(that : Yottabit) : Bool
    return this.equalsTo(that.toBigInt());
  public function nearEquals(that : Yottabit) : Bool
    return Floats.nearEquals(this.toFloat(), that.toFloat());
  @:op(A!=B) inline public function notEquals(that : Yottabit) : Bool
    return !this.equalsTo(that.toBigInt());
  @:op( A<B) inline public function less(that : Yottabit) : Bool
    return this.lessThan(that.toBigInt());
  @:op(A<=B) inline public function lessEquals(that : Yottabit) : Bool
  ...
  @:op(A>=B) inline public function greaterEquals(that : Yottabit) : Bool
